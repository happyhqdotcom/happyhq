...
| 7   | Exercise step (PROMPT step 6a) couldn't confirm the touched surfaces still work — a regression was visible after one rework attempt, OR the surface couldn't be reached       | `ralphie:skip-cannot-verify`       | Maintainer reads the comment + evidence, decides whether to fix locally, scope manually, or close |
