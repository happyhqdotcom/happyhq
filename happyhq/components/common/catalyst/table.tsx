...
export function TableHeader({
  ...
  return (
    <th
      ...
      className={clsx(
        className,
        'border-b border-b-zinc-950/10 px-4 py-2 font-medium first:pl-(--gutter,--spacing(4)) last:pr-(--gutter,--spacing(4)) dark:border-b-white/10',
        grid &&
...
export function TableCell({
  ...
  return (
    <td
      ...
      className={clsx(
        className,
        'relative px-4 first:pl-(--gutter,--spacing(4)) last:pr-(--gutter,--spacing(4))',
