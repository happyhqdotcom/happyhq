...
const base = [
  // Basic layout
  'relative isolate flex size-4.5 items-center justify-center sm:size-4',
  // Background color + shadow applied to inset pseudo element, so shadow blends with border in light mode
  'before:absolute before:inset-0 before:-z-10 before:bg-white/5 before:shadow-sm',
  ...
  'after:absolute after:inset-0 after:shadow-[inset_0_1px_--theme(--color-white/15%)]',
  'dark:after:-inset-px dark:after:hidden dark:group-data-checked:after:block',
  // Focus ring
...
export function Checkbox({
  ...
  return (
    ...
    >
      <span className={clsx([base, variants[variant], colors[color]])}>
        <svg
        ...
        >
          ...
          <path
            className={clsx(
              ...
              variant === 'circular' && 'origin-center scale-75',
            )}
            d="M3 8L6 11L11 3.5"
            strokeWidth={2}
            strokeLinecap="round"
