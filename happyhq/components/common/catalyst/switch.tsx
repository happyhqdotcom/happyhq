...
const colors = {
  ...
  automation: [
    '[--switch-bg-ring:var(--color-zinc-900)]/60 [--switch-bg:var(--color-zinc-900)]/40 dark:[--switch-bg-ring:transparent]',
    '[--switch:white] [--switch-ring:var(--color-zinc-900)]/60 [--switch-shadow:var(--color-zinc-900)]/20',
    // Optional third element: custom unchecked state with hover preservation
    'bg-zinc-900/40 dark:bg-zinc-700/70 ring-1 ring-zinc-900/50 data-hover:ring-zinc-900/50 dark:data-hover:ring-zinc-900/50',
  ],
}

type Color = keyof typeof colors

// Default unchecked state styles
const defaultUncheckedStyles =
...
export function Switch({
  ...
  const uncheckedStyles = colorStyles[2] || defaultUncheckedStyles
  ...
  return (
    <Headless.Switch
      ...
      className={clsx(
        ...
        // Unchecked - use custom or default
        uncheckedStyles,
        // Checked
